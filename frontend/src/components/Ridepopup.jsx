      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="flex mt-5 items-center justify-between w-full">
          <button
            ...
            className=" mt-5 bg-gray-300 text-gray font-semibold  px-10 p-3 rounded-lg"
          >
            Ignore
          </button>
          <button
            ...
            className=" mt-5 bg-green-600 text-white font-semibold px-10  p-3 rounded-lg"
          >
            Accept
          </button>
        </div>
