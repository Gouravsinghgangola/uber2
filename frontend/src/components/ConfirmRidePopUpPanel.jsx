...
const ConfirmRidePopUpPanel = (props) => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center  p-3 rounded-lg mt-3  bg-gray-500 justify-between">
        ...
        <div className="mt-6 w-full">
          ...
          >
            <input
              ...
              type="text"
              className="bg-[#eeeeee] px-6 font-mono py-3 text-base w-full mt-3 rounded-lg"
              placeholder="Enter OTP"
            />
            <Link
              to="/captain-riding"
              onClick={() => {}}
              className="w-full mt-5 text-lg bg-green-600 flex justify-center text-white font-semibold p-3 rounded-lg"
            >
              Confirm
            </Link>
            <button
              ...
              className="w-full mt-3 bg-red-500  text-lg text-white font-semibold p-3 rounded-lg"
            >
              Cancel
            </button>
          </form>
